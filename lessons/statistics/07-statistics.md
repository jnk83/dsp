...
>> Bayes uses probabilities for both hypotheses and data, while Frequentist does not use the probability of a hypothesis.  Bayes depends on observed data, while Frequentist depends on both observed and unobserved.  Bayes is more computationally intensive, while Frequentist is less computationally intensive.
